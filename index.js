...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@job-portal.v9sirbg.mongodb.net/job-portal`;
// mongodb+srv://nickkaploon:pm0qJ0cJVfL0TNSq@job-portal.v9sirbg.mongodb.net/?retryWrites=true&w=majority
